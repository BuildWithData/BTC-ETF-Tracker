...
parser = argparse.ArgumentParser(description="update table inflows_bfill")
...
QUERY = "select * from holdings_bfill"

##################
# READ
extracted = pd.DataFrame(
    c.execute(QUERY),
    columns=["ref_date", "week", "day"] + TICKERS + ["TOTAL_BTC", "TOTAL_ETH"],
)
...
if force is True:
    ...
    DELETE_QUERY = "DELETE FROM inflows_bfill "
...
for row in out.itertuples():
    ...
    INSERT_QUERY = "INSERT INTO inflows_bfill VALUES ("
