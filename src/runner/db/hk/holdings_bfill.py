...
from utils.constants import HK_BTC_TICKERS
from utils.constants import HK_ETH_TICKERS
import warnings
...
parser = argparse.ArgumentParser(description="update table holdings_bfill")
...
TICKERS = sorted(HK_BTC_TICKERS + HK_ETH_TICKERS)
...
if force is True:
    ...
    DELETE_QUERY = "DELETE FROM holdings_bfill "
...
for row in out.itertuples():
    ...
    INSERT_QUERY = "INSERT INTO holdings_bfill VALUES ("
